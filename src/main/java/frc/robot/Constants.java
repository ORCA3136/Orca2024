...
public final class Constants {
  public static final class DriveConstants {
    ...
    public static final double kMaxSpeedMetersPerSecond = 4.0; // 5.66;
    public static final double kMaxAngularSpeed = 2.5 * Math.PI; //2.5 * Math.PI; // radians per second

    public static final double kDirectionSlewRate = 4.2; // radians per second
    public static final double kMagnitudeSlewRate = 5.8; // percent per second (1 = 100%)
  ...
  public static final class ArmPIDConstants {
    ...
    public static final double armkP = 0.022;
    public static final double armkI = 0;
    public static final double armkD = 0.15;
    public static final double armkG = 0.05;
    ...
    public static final double STAGE = 25;
    public static final double SAFE = 48;
    public static final double SOURCE = 69;
    public static final double AMP = 90;
  }

  public static final class AutoConstants { // auto constants

    public static final double kMaxSpeedMetersPerSecond = 5; // 2.5  
