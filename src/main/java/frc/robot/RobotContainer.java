...
public class RobotContainer {
  ...
  */
  ...
  private void configureButtonBindings() {
    ...
    new JoystickButton(m_driverController, 6).whileTrue(RunShooterCommand(0.5));
    */
    new JoystickButton(m_driverController, 7).whileTrue(SetSwerveXCommand());
    //new JoystickButton(m_driverController, 8).whileTrue(FollowPathCommand("MoveS"));
  }
